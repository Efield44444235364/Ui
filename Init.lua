...
do
    Assets.Config.Save = function(File, data)
        writefile("Kawnew Premium Script/Config/"..File..".json", HttpService:JSONEncode(data))
    end
    
    Assets.Config.Load = function(File, set)
        if isfile("Kawnew Premium Script/Config/"..File..".json") then
            local data = readfile("Kawnew Premium Script/Config/"..File..".json")
...
do
    ...
    Assets.Font.create_family = function(name: string, faces: { FontFace })
        ...
        writefile("Kawnew Premium Script/Assets/Fonts/"..name..".json", HttpService:JSONEncode(family))

        local id = getcustomasset("Kawnew Premium Script/Assets/Fonts/"..name..".json")
...
do    
    if not Night then 
        LocalPlayer:Kick("Kawnew not supported/couldn't load global environment")
        return 
    end
    ...
    Assets.Main.Load = function(file)
        ...
        if not Night.Dashboard then
            ...
            Assets.Functions.LoadFile("Kawnew Premium Script/Games/"..file..".lua", "https://raw.githubusercontent.com/warprbx/NightRewrite/refs/heads/main/Night/Games/"..file..".lua")
